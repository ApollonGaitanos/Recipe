...
export default function RecipeCard({ recipe, onClick, onEdit, onDelete, onToggleVisibility }) {
    const { t } = useLanguage();
    const { user } = useAuth();
        ...
        <>
            <div className="recipe-card" onClick={() => onClick(recipe.id)}>
                <div className="card-content">
                    ...
                    {/* Action Buttons (Edit/Delete/Toggle) - Only for Owner */}
                    {isOwner && (
            ...
            <VisibilityModal
                ...
                onConfirm={() => onToggleVisibility(recipe.id, recipe.is_public)}
