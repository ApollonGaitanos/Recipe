                        ...
                        <div key={category.id} className="relative flex-1 min-w-[150px] max-w-[240px]">
                            ...
                            >
                                <div className="flex items-center gap-2 overflow-hidden flex-1">
                                    ...
                                    <div className={`rounded-lg flex items-center justify-center shrink-0 ${compact ? 'w-7 h-7' : 'w-9 h-9'} ${activeCount > 0 ? 'bg-white text-[#63886f] dark:bg-black/20 dark:text-[#8ca395]' : 'bg-gray-100 dark:bg-white/5 text-gray-500'
                                        }`}>
                                        {activeCount === 0 ? (
