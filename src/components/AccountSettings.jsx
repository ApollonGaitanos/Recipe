...
import { User as UserIcon, Settings, LogOut, ChevronRight, Camera, Save } from "lucide-react";
...
const AccountSettings = () => {
    ...
    const menuItems = [
        ...
        { id: "notifications", label: "Notifications", icon: Settings }, // Placeholder
        { id: "privacy", label: "Privacy & Security", icon: Settings }, // Placeholder
    ];

    return (
        <div className="min-h-screen bg-[#F6F8F6] dark:bg-black pt-20 pb-12 px-4 sm:px-6">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                                ...
                                {menuItems.map((item) => {
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-colors text-sm font-medium ${isActive
                    ...
                    <main className="flex-1">
                        <div className="bg-white dark:bg-surface-dark rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-8">
                            {/* Profile Header (No Image as requested, just Initials/Info) */}
                            <div className="flex items-start justify-between mb-8 pb-8 border-b border-gray-100 dark:border-gray-700">
                                <div>
                                ...
                                <div className="flex items-center gap-4">
                                    <div className="w-16 h-16 rounded-full bg-primary/10 dark:bg-primary/20 flex items-center justify-center text-primary dark:text-green-400 text-2xl font-bold font-serif">
                            ...
                            <div className="space-y-6">
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full px-4 py-2.5 rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all outline-none"
                                            placeholder="Jane"
                                        />
                                    </div>
                                    <div>
                                ...
                                {/* Dietary Preferences */}
                                <div>
                                    <h3 className="text-sm font-medium text-gray-700 dark:text-white mb-3">Dietary Preferences</h3>
                                    <div className="flex flex-wrap gap-2">
                                        {['Vegetarian', 'Vegan', 'Gluten-Free', 'Keto', 'Paleo'].map((option) => (
                                            <button
                                                key={option}
                                                onClick={() => toggleDietary(option)}
                                                className={`px-4 py-2 rounded-full text-sm font-medium transition-all ${formData.dietary?.includes(option)
                                ...
                                {/* Actions */}
                                <div className="pt-6 mt-8 border-t border-gray-100 dark:border-gray-700 flex items-center justify-end gap-3">
                                    <button
